...
from biokbase.narrativejobproxy.impl import NarrativeJobProxy
impl_NarrativeJobProxy = NarrativeJobProxy(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'NarrativeJobProxy'
        ...
        self.rpc_service.add(impl_NarrativeJobProxy.ver,
                             name='NarrativeJobProxy.ver',
                             types=[])
        self.method_authentication['NarrativeJobProxy.ver'] = 'none'
        self.rpc_service.add(impl_NarrativeJobProxy.get_detailed_error,
                             name='NarrativeJobProxy.get_detailed_error',
                             types=[basestring])
        self.method_authentication['NarrativeJobProxy.get_detailed_error'] = 'required'
        self.rpc_service.add(impl_NarrativeJobProxy.get_job_info,
        ...
        if environ['REQUEST_METHOD'] == 'OPTIONS':
            ...
            try:
                ...
                try:
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "NarrativeJobProxy but no authentication header was passed"
                            raise err
                    ...
                    impl_NarrativeJobProxy.ctx = ctx
